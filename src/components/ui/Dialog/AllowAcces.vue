...
<template>
   <dialog id="shared-file-dialog" class="shadow-lg rounded-md flex flex-col lg:w-[35vw] max-md:w-[80vw] max-sm:w-[75vw] h-fit text-[#808080] scale-[0.9] p-10">
        ...
        <div class="flex flex-col w-full">
            ...
            <form class="flex flex-col items-center max-sm:text-xs my-4" @submit="handleAdd">
                <p class="max-md:text-lg mb-1 max-sm:text-sm text-gray-600">Make this file available to another group</p>
