...
<template>
    <div v-if="route.fullPath==='/'" class="fixed bottom-8 text-gray-700 bg-white max-sm:left-14 max-sm:right-2 sm:right-14 z-50 rounded-md shadow-md shadow-gray-500">
