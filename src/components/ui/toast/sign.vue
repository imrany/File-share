...
<template>
    <div id="welcome_toast" @click="closeWelcomeToast" class="fixed bottom-0 top-0 left-0 right-0 z-40" style="display:none;">
        <div class="fixed bottom-8 text-gray-700 bg-white max-sm:left-14 max-sm:right-2 sm:right-14 z-50 rounded-md shadow-md shadow-gray-500">
            <div class="flex flex-col">
                <button  class="ml-[auto] outline-none m-2" @click="closeWelcomeToast">
