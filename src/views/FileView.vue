...
<template>
    <div class="flex flex-col pb-8 bg-black min-h-[100vh] text-white">
        <div class="">
        ...
        <div class="flex w-[100vw]">
            ...
            <div class="flex items-center justify-center flex-grow">
               <object :data="`${origin}/${route.query.file}`" type="" class="object-contain w-full h-[93vh] max-md:w-[100vw]"></object>
            </div>
        </div>
     </div>
</template>
