    ...
    <div class="flex flex-col bg-[#fffbf7] justify-center items-center h-[100vh]">
        ...
        <div class="flex flex-col justify-center items-center md:w-[450px] max-md:w-[80vw] mb-20">
            ...
            <form class="my-3 flex flex-col w-full" @submit="handleSubmit">
                <label for="username" class="ml-1 flex justify-between"><span>Enter your preferred username</span><span class="text-red-600 text-sm" v-if="username.length>0&&username.length<5">Too short</span><span class="text-green-600 text-sm" v-else-if="username.length>4">Good</span></label>
